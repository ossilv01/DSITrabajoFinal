...
public class Obediencia : VisualElement
{
    // Start is called before the first frame update
    const int MAX = 4;

    int valor = 4;
    string iconFull = "barblue";
    ...
    public new class UxmlFactory : UxmlFactory<Obediencia, UxmlTraits> { }
    ...
    public new class UxmlTraits : VisualElement.UxmlTraits
    {
        ...
        UxmlStringAttributeDescription fullAttr =
            new UxmlStringAttributeDescription { name = "full", defaultValue = "barblue" };
    ...
    new StyleBackground(Resources.Load<Texture2D>("minus"));
    ...
    new StyleBackground(Resources.Load<Texture2D>("plus"));
